...
#
# POKEDEX USING PYTHON AND FLASK
# by: KennyNeutron
# https://github.com/KennyNeutron
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.btn_Search = QtWidgets.QPushButton(
            self.centralwidget, clicked=lambda: self.pressed_btn_Search()
        )
        ...
        self.btn_Prev = QtWidgets.QPushButton(
            self.centralwidget, clicked=lambda: self.pressed_btn_Prev()
        )
        ...
        self.btn_Next = QtWidgets.QPushButton(
            self.centralwidget, clicked=lambda: self.pressed_btn_Next()
        )
    ...
    def pressed_btn_Search(
        self,
    ):  # remove this function later, this is only for testing
    ...
    def update_BaseStats(self):
        ...
        self.pb_SpAttack.setValue(
            int(self.pokemon_data["base_stats"]["special_attack"])
        )
        self.lbl_SpDef.setText(str(self.pokemon_data["base_stats"]["special_defense"]))
        self.pb_SpDefense.setValue(
            int(self.pokemon_data["base_stats"]["special_defense"])
        )
