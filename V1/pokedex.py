...
def search_pokemon():
    ...
    if "error" in pokemon_data:
        ...
        result_text.insert("end", f"{pokemon_data['height'] * 0.1:.1f}m\n", "data")
        result_text.insert("end", "Weight: ", "bold")
        result_text.insert("end", f"{pokemon_data['weight'] * 0.1:.1f}kg\n", "data")
        ...
        result_text.insert(
            "end", f"{pokemon_data['base_stats']['special_attack']}\n", "data"
        )
        result_text.insert("end", "  ", "data")
        result_text.insert("end", "Special Defense: ", "sub_bold")
        result_text.insert(
            "end", f"{pokemon_data['base_stats']['special_defense']}\n", "data"
        )
        result_text.insert("end", "  ", "data")
